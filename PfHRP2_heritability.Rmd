...
boxplot(log_parasites ~ frem3_rs186790584, kemri_case_data,
        ylab='Parasite density (per/ul)',yaxt='n',
...
boxplot(log_hrp2 ~ frem3_rs186790584, kemri_case_data,
        ylab='Plasma PfHRP2 (ng/ml)', yaxt='n',
        varwidth=T, xlab = expression(italic(FREM3))); grid()
axis(2, at = 1:5, 
     labels = c(10,
...
load('../../Defining_Severe_Malaria/SevereMalariaDiagnosis/Rout/mod2_LC_all_cor.stanfit')
thetas = extract(out_all_cor)
